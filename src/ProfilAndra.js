...
export default function ProfilAndra() {
  ...
  const pendidikan = [
    { tahun: "2022 - 2025", institusi: "Pondok Pesantren Walisongo Ngabar", jurusan: "Desain Komunikasi Visual" },
